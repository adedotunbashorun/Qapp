                ...
                <table id="response-table" class="table mb-0" style="margin:20px;">
                    ...
                    <tbody>
                        <tr v-for="(response, index) in responses" :key="index">
                            ...
                            <td><a href="#" :data-data="response.data" data-toggle="modal" data-target="#getDetails" data-remote="false" class="bs-tooltip" data-original-title="Details">View</a></td>
                        </tr>
                    </tbody>
                </table>
                </div>
...
export default {
    ...
    methods:{
      sendMessage(){
        this.reply.user_id = $("#reply #user_id").val()
